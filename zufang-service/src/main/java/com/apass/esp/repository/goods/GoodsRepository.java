...
public class GoodsRepository extends BaseMybatisRepository<GoodsInfoEntity, Long> {
    ...
    public List<GoodsInfoEntity> selectByCategoryId1(Long categoryId) {
        return this.getSqlSession().selectList("selectByCategoryId1", categoryId);
    }
    ...
    public GoodsInfoEntity selectGoodsByGoodsId(String goodsId) {
        return this.getSqlSession().selectOne("selectGoodsByGoodsId",goodsId);
    }
    ...
    public int insertSelective(GoodsInfoEntity entity) {
        return getSqlSession().insert("insertSelective", entity);
    }
