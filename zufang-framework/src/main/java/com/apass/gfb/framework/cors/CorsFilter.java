 ...
 */
package com.apass.gfb.framework.cors;
...
/**
 * spring security headers will seprate multiple values, which will cause error
 * in android browser with this filter we should not handle pre flight OPTION
 * request via StopperFilter in SS any mor
 * 
 * With @WebFilter there should be no need to register in web.xml or
 * web-fragment.xml
 * 
...
public final class CorsFilter implements Filter {
	...
	protected void handlePreflightCORS(final HttpServletRequest request, final HttpServletResponse response,
		...
		if (requestType != CORSRequestType.PRE_FLIGHT) {
			throw new IllegalArgumentException(
					sm.getString("corsFilter.wrongType1", CORSRequestType.PRE_FLIGHT.name().toLowerCase()));
		}
	 ...
	 * 
	 * @see <a href="http://tools.ietf.org/html/rfc2616#section-5.1.1" >http://
	 *      tools.ietf.org/html/rfc2616#section-5.1.1</a>
	 * 
	 */
	 ...
	 * 
	 * @see <a href="http://www.w3.org/TR/cors/#terminology" >http://www.w3.org/
	 *      TR/cors/#terminology</a>
	 */
	...
	public static final Collection<String> SIMPLE_HTTP_RESPONSE_HEADERS = new HashSet<String>(
			Arrays.asList("Cache-Control", "Content-Language", "Content-Type", "Expires", "Last-Modified", "Pragma"));
