...
import com.apass.gfb.framework.security.authentication.ListeningAuthenticationFailureHandler;
import com.apass.gfb.framework.security.authentication.ListeningAuthenticationSuccessHandler;
import com.apass.gfb.framework.security.authentication.ListeningUsernamePasswordAuthenticationFilter;
 ...
 * @since 3.2
 */
public final class ListeningFormLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
                                               AbstractAuthenticationFilterConfigurer<H, ListeningFormLoginConfigurer<H>, ListeningUsernamePasswordAuthenticationFilter> {

    /**
     * Creates a new instance
     * @see HttpSecurity#formLogin()
     */
    public ListeningFormLoginConfigurer() {
        super(new ListeningUsernamePasswordAuthenticationFilter(), null);
     ...
     *            (i.e. "/login")
     * @return the {@link ListeningFormLoginConfigurer} for additional customization
     */
    public ListeningFormLoginConfigurer<H> loginPage(String loginPage) {
     ...
     * @return the {@link ListeningFormLoginConfigurer} for additional customization
     */
    public ListeningFormLoginConfigurer<H> usernameParameter(String usernameParameter) {
     ...
     * @return the {@link ListeningFormLoginConfigurer} for additional customization
     */
    public ListeningFormLoginConfigurer<H> passwordParameter(String passwordParameter) {
    ...
    /**
     * Custom Init Form Login Settings
     * 
     * @return ListeningFormLoginConfigurer
     */
    public ListeningFormLoginConfigurer<H> customSetting(boolean useHandler) {
        this.loginPage("/login").defaultSuccessUrl("/main", true).failureUrl("/login?error");
        if (!useHandler) {
            return this;
        }
        ListeningAuthenticationFailureHandler failHandler = new ListeningAuthenticationFailureHandler();
        failHandler.setDefaultFailureUrl("/login?error");
        ListeningAuthenticationSuccessHandler successHandler = new ListeningAuthenticationSuccessHandler();
        successHandler.setAlwaysUseDefaultTargetUrl(true);
        successHandler.setDefaultTargetUrl("/main");
        return this.successHandler(successHandler).failureHandler(failHandler);
    }
}
